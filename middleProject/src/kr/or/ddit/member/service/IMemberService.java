...
public interface IMemberService {
	...
	/**
	 * 회원의 ID를 받아 회원의 탈퇴 여부를 0으로 변경하는 메서드 (0은 탈퇴한 회원, 1은 기존 회원)
	 * 
	 ...
	 * @return 해당 ID가 있으면 String 객체, 없으면 null반환
	 */
	public String selectById(String memId);
	
	/**
	 * 회원  ID,PASSWORD가 저장된 MemeberVo객체를 인수값으로 받아서 해당회원을 검색하여 반환하는 메서드
	 * 
	 ...
	 * @return 해당 mail이  String 객체, 없으면 null반환
	 */
